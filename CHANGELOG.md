...
- Bugfix DCC BiDi channel 1 collision invalidates entire datagram ([#153](https://github.com/OpenRemise/Firmware/issues/153))
- Bugfix RMT memory corruption ([#160](https://github.com/OpenRemise/Firmware/issues/160))
