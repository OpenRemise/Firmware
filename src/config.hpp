...
#  define ADC_CHANNEL_1 static_cast<adc_channel_t>(1)
#  define ADC_CHANNEL_2 static_cast<adc_channel_t>(2)
#  define ADC_CHANNEL_3 static_cast<adc_channel_t>(3)
#  define ADC_CHANNEL_4 static_cast<adc_channel_t>(4)
#  define ADC_CHANNEL_5 static_cast<adc_channel_t>(5)
#  define ADC_CHANNEL_6 static_cast<adc_channel_t>(6)
#  define ADC_CHANNEL_7 static_cast<adc_channel_t>(7)
#  define ADC_CHANNEL_8 static_cast<adc_channel_t>(8)
#  define ADC_CHANNEL_9 static_cast<adc_channel_t>(9)
#  define ADC_ATTEN_DB_0 static_cast<adc_atten_t>(0)
#  define ADC_ATTEN_DB_2_5 static_cast<adc_atten_t>(1)
#  define ADC_ATTEN_DB_6 static_cast<adc_atten_t>(2)
#  define ADC_ATTEN_DB_11 static_cast<adc_atten_t>(3)
