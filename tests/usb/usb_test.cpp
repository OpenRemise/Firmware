...
UsbTest::UsbTest() {
  ...
  task_create_stub(ulf::dcc_ein::task.handle);
  task_create_stub(ulf::decup_ein::task.handle);
  task_create_stub(ulf::susiv2::task.handle);
}
...
UsbTest::~UsbTest() {
  ...
  task_delete_clear_handle(ulf::dcc_ein::task.handle);
  task_delete_clear_handle(ulf::decup_ein::task.handle);
  task_delete_clear_handle(ulf::susiv2::task.handle);
}
